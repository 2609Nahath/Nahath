...
class SingleCompletedItem extends StatefulWidget {
  ...
  const SingleCompletedItem(this.title, this.description, {Key? key})
      : super(key: key);

  @override
  State<SingleCompletedItem> createState() => _SingleCompletedItemState();
}

class _SingleCompletedItemState extends State<SingleCompletedItem> {
  var projectTaskArr = [
  ...
  ShowProjectTask_Completed showProjectTask = ShowProjectTask_Completed();
